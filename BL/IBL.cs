...
namespace BL
{
    public interface IBL
    {
        ...
        void AccommodationStarsUpdate(int accommodationKey, string hostKey, int stars);
        ...
        void AccommodationSumOfUnitsUpdate(int accommodationKey, string hostKey, int sumOfUnits);
        ...
        /// <param name="sorted"></param>
        /// <returns></returns>
        IEnumerable<IGrouping<int, GuestRequest>> GetGuestRequestGroupBySumOfHosted(bool sorted = false);
